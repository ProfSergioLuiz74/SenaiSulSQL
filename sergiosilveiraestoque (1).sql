...
--
-- Banco de dados: `sergiosilveiraestoque`
--
CREATE DATABASE IF NOT EXISTS `sergiosilveiraestoque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sergiosilveiraestoque`;
